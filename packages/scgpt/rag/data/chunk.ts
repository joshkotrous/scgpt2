...
export function generateExtractedDataChunks(
  extractedData: UEXPlatformDataExtraction,
  maps: UEXPlatformDataExtractionMaps
) {
  console.log("Starting comprehensive data chunk generation...");

  // Combine chunks from all generation functions
  const chunks = [
    // Generate chunks for different data categories
    ...generateStarSystemChunks(extractedData, maps),
    ...generateLocationChunks(extractedData, maps),
    ...generateFactionChunks(extractedData, maps),
    ...generateJurisdictionChunks(extractedData, maps),
    ...generateTerminalChunks(extractedData, maps),
    ...generateCompaniesChunks(extractedData, maps),
    ...generateVehiclesChunks(extractedData, maps),
    ...generateItemsChunks(extractedData, maps),

    // Commodities and Trading
    ...generateCommoditiesChunks(extractedData, maps),
    ...generateAllCommodityPriceChunks(extractedData, maps),
    ...generateRawCommodityPriceChunks(extractedData, maps),
    ...generateCommodityTradingChunks(extractedData, maps),
    ...generateCommodityPriceHistoryChunks(extractedData, maps),
  ];

  console.log(`Generated total of ${chunks.length} chunks for embedding`);
